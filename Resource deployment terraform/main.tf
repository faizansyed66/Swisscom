...
module "loadbalancer" {
  ...
  interface_name = module.compute.interface_name
  interface_ip = module.compute.interface_ip
  interface2_name = module.compute.interface2_name
  interface2_ip = module.compute.interface2_ip
